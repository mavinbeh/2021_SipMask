...
python -m debugpy --listen 0.0.0.0:5678 --wait-for-client tools/test_video.py configs/sipmask/sipmask_r50_caffe_fpn_gn_ms_1x_mavinbe_clone.py checkpoints/vis_sipmask_ms_1x_final.pth --out results/results.pkl --eval bbox segm --show --save_path results/images
